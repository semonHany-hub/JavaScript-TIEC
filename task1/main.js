...
/**
 * Task 1:
 * From the previous products object
 * get last review in last product and from it console.log
 * in the following shape
 * {reviewerName}:{reviewerEmail} rated this product with {rating} stars,
	 and left this comment for you: {comment}
 */

	 console.log(products["products"][29]["reviews"][2]["reviewerName"] + " : "
		+products["products"][29]["reviews"][2]["reviewerEmail"] + " rated this product with "
		+products["products"][29]["reviews"][2]["rating"] + " stars, and left this comment for you: "
		+products["products"][29]["reviews"][2]["comment"]);

/**
 * Task 2:
 * From the previous products object
 * change the last review (reviewerName, reviewerEmail, comment, rating) in the last product with data from your chosen.
 */

    products["products"][29]["reviews"][2]["reviewerName"] = "semon hany";
	products["products"][29]["reviews"][2]["reviewerEmail"] = "semonhanyadly555@gmail.com";
    products["products"][29]["reviews"][2]["rating"] = "3";
	products["products"][29]["reviews"][2]["comment"] = "I really liked this product and I think it's good for you";
